...
| نواة S0 headless | **IMPLEMENTED** بعقد أوامر منظم وبديل حتمي للاختبارات | [`src/nexora_vpe/`](src/nexora_vpe/). |
...
ينفذ runtime الحالي عقد orchestration واختباراته ببديل حتمي؛ ويثبت bridge C++ أن واجهة Pulse SDK الحقيقية تدعم تحميل الحالة والنزف الطحالي الداخلي والتقدم والحفظ والاستعادة. لم يُشبك adapter Python الإنتاجي بعملية Pulse بعد؛ ولذلك لا ينبغي مساواة العرض الحتمي بمحاكاة Pulse الحقيقية.
...
| `src/physiology/pulse_bridge/` | bridge C++ حقيقي ومحدود إلى Pulse SDK. |
