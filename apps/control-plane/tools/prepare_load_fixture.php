...
$version = ScenarioVersion::query()->create(['tenant_id' => $tenant->id, 'scenario_id' => $scenario->id, 'version_number' => 1, 'status' => 'published', 'title' => 'Load Scenario v1', 'metadata' => [], 'created_by' => $user->id, 'published_at' => now()]);
