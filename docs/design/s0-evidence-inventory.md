...
| `E-CHECKPOINT` | artifact محرك منفصل وdigest | `checkpoint.created` | retry/debug | artifact داخل الجلسة؛ الاستعادة مشروطة بالإصدار وعقد adapter ولا تثبت الاستمرارية عبر إعادة التشغيل. |
